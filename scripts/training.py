...
def train_ner_trf(
    ...
    """Trains/fine-tunes the transformer NER pipeline on GPU.
    ...
    Args:
        ...
        eval_frequency: Frequency of evaluation on dev set.
    ...
    logger.info(f"Starting transformer training on GPU {use_gpu} for {max_steps} steps...")
...
if __name__ == "__main__":
    ...
    res = train_ner_trf(max_steps=args.steps, eval_frequency=args.eval_freq, use_gpu=args.gpu_id)
